...
# 压力项目（FIO/CPU/内存/GPU/NCCL）由 DWlhtest.sh 脚本执行
# 用法：sudo bash DWtest.sh
...
cleanup(){
    ...
    rm -rf pcinfo.txt pcinfo1.txt net.txt block.txt /tmp/dmesg_filter_*.tmp /tmp/sel_filter_*.tmp
